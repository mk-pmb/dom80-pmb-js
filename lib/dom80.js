...
(function () {
  ...
  D.matryoshka = function matryoshka(tagName, classNames, augment) {
    if (!D.isStr(tagName)) { return D.matryoshka('div', classNames); }
    var m = [], d, i;
    classNames.forEach(function add(c) {
      d = doc.createElement(tagName);
      d.className = c;
      if (augment) { d = augment(d, m) || d; }
      if (i) { i.appendChild(d); }
      i = d;
      m.push(d);
    });
    m.innermost = i;
